...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ipydagred3-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ipydagred3-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install ipydagred3
```
...
It is possible to list all of the versions of `ipydagred3` available on your platform:
...
```
pixi search ipydagred3 --channel conda-forge
```
